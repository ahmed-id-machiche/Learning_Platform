...
const AuthLayout = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row bg-slate-950 text-slate-100 font-sans selection:bg-blue-600 selection:text-white">
      {/* Left Column: Premium OFPPT Branding Hero Panel */}
      <div className="relative lg:w-1/2 min-h-[400px] lg:min-h-screen bg-gradient-to-br from-blue-950 via-indigo-950 to-slate-950 p-8 sm:p-12 lg:p-16 flex flex-col justify-between overflow-hidden border-b lg:border-b-0 lg:border-r border-slate-800/80">
        {/* Ambient Glowing Lighting Effects */}
        <div className="absolute top-0 left-0 -mt-20 -ml-20 w-96 h-96 rounded-full bg-blue-600/20 blur-3xl pointer-events-none" />
        <div className="absolute bottom-0 right-0 -mb-20 -mr-20 w-96 h-96 rounded-full bg-indigo-500/20 blur-3xl pointer-events-none" />
        <div className="absolute top-1/2 left-1/3 w-80 h-80 rounded-full bg-sky-400/10 blur-3xl pointer-events-none" />

        {/* Brand Header */}
        <div className="relative z-10 flex items-center gap-x-3">
          <div className="h-12 w-12 rounded-2xl bg-gradient-to-tr from-blue-600 via-indigo-600 to-sky-400 flex items-center justify-center shadow-lg shadow-blue-500/25 ring-1 ring-white/20">
        ...
        <div className="relative z-10 my-10 lg:my-0 space-y-6 max-w-xl">
          <div className="inline-flex items-center gap-x-2 bg-blue-500/10 border border-blue-400/20 px-3.5 py-1.5 rounded-full text-xs font-semibold text-blue-300 backdrop-blur-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
            <div className="flex items-center gap-x-3 p-3 rounded-xl bg-white/5 border border-white/10 backdrop-blur-md">
              <div className="p-2 rounded-lg bg-blue-500/20 text-sky-400">
                <BookOpen className="h-4 w-4" />
              </div>
              <span className="text-xs font-medium text-slate-200">Modules par Filières</span>
            </div>
            ...
            <div className="flex items-center gap-x-3 p-3 rounded-xl bg-white/5 border border-white/10 backdrop-blur-md">
              ...
              <span className="text-xs font-medium text-slate-200">TPs & EFMs Corrigés</span>
            </div>
            ...
            <div className="flex items-center gap-x-3 p-3 rounded-xl bg-white/5 border border-white/10 backdrop-blur-md">
              ...
              <span className="text-xs font-medium text-slate-200">Assistant IA Pédagogique</span>
            </div>
            ...
            <div className="flex items-center gap-x-3 p-3 rounded-xl bg-white/5 border border-white/10 backdrop-blur-md">
              ...
              <span className="text-xs font-medium text-slate-200">Certificats & Ateliers</span>
            </div>
          </div>
        </div>
      ...
      {/* Right Column: Clerk Auth Card Area */}
      <div className="lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-slate-100 min-h-[600px] lg:min-h-screen relative">
